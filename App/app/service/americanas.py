...
def getProductPrice(price, governement_taxes): 
    ...
    if price < 40: price_result = price + tax_result + shipping_result +governement_taxes_result
    if price >=40: price_result = price + fix_tax +tax_result + shipping_result +governement_taxes_result
